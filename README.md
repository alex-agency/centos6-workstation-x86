...
```
docker run -it --rm -p 5900:5900 -p 3389:3389 -v /var/run/docker.sock:/var/run/docker.sock -v $(which docker):/bin/docker -v /shared:/home/user/Public alexagency/centos6-workstation-x86
```
